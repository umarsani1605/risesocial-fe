<template>
  <div v-if="topics?.length" class="rounded-md border">
    <Table>
      <TableHeader>
        <TableRow>
          ...
          <TableHead class="px-4 sticky right-0 text-right">Actions</TableHead>
        </TableRow>
      </TableHeader>
      <TableBody>
        <TableRow
        ...
        >
          ...
          <template v-if="row.type === 'topic'">
            ...
            <TableCell>{{ row.data.topic_order }}</TableCell>
