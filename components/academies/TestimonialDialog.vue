      ...
      <form @submit.prevent="onSubmit" class="space-y-4">
        <FormField v-slot="{ componentField }" name="name">
          <FormItem>
            ...
            <FormControl>
              <Input v-bind="componentField" placeholder="Student name..." />
            </FormControl>
          </FormItem>
        </FormField>
        ...
        <FormField v-slot="{ componentField }" name="comment">
          <FormItem>
            ...
            <FormControl>
              <Textarea v-bind="componentField" placeholder="Share the student's testimonial..." rows="4" />
            </FormControl>
          </FormItem>
        </FormField>
...
const formSchema = toTypedSchema(
  z.object({
    ...
    comment: z.string().min(1, 'Testimonial is required'),
...
const dialogDescription = computed(() => (isEditMode.value ? 'Update the testimonial for this academy.' : 'Add a new testimonial for this academy.'));
  ...
  async (values) => {
    try {
      ...
      if (isEditMode.value) {
        ...
        await $api(`/admin/academies/${props.academyId}/testimonials/${props.data.id}`, {
          method: 'PUT',
          body: formData,
        });
        ...
        await $api(`/admin/academies/${props.academyId}/testimonials`, {
          method: 'POST',
          body: formData,
        });
