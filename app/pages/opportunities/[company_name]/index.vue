          ...
          <div class="flex-1 min-w-0 space-y-8">
            ...
            <div class="grid gap-x-12 gap-y-4 md:grid-flow-col md:grid-rows-4 md:auto-cols-fr">
              <div class="max-w-xl space-y-4">
                ...
                <div v-else-if="company.linkedin_type" class="flex items-center">
                  <UIcon name="i-ph-buildings-bold" class="mr-2 size-4 shrink-0 text-muted" />
                  <span><span class="font-medium">Type:</span> {{ company.linkedin_type }}</span>
                </div>
                <div v-if="company.linkedin_size" class="flex items-center">
                  <UIcon name="i-ph-users-bold" class="mr-2 size-4 shrink-0 text-muted" />
                  <span><span class="font-medium">Size:</span> {{ company.linkedin_size }}</span>
                </div>
                <div v-else-if="company.linkedin_employees" class="flex items-center">
                  <UIcon name="i-ph-users-three-bold" class="mr-2 size-4 shrink-0 text-muted" />
                  <span
                    ><span class="font-medium">Employees:</span>
                    {{ formatNumber(company.linkedin_employees) }}</span
                  >
                </div>
                <div v-if="company.linkedin_followers" class="flex items-center">
                  <UIcon name="i-ph-user-plus-bold" class="mr-2 size-4 shrink-0 text-muted" />
                  <span
                    ><span class="font-medium">Followers:</span>
                    {{ formatNumber(company.linkedin_followers) }}</span
                  >
                </div>
                <div v-if="company.linkedin_founded_date" class="flex items-center">
                ...
                <div v-if="companyHeadquarters" class="flex items-center">
              ...
              <div class="space-y-4">
                <div v-if="company.website_url" class="flex items-center">
                  <UIcon name="i-ph-globe-bold" class="mr-2 size-4 shrink-0 text-muted" />
                  <ULink
                ...
                <div v-if="company.linkedin_url" class="flex items-center">
                  <UIcon name="i-ph-linkedin-logo-bold" class="mr-2 size-4 shrink-0 text-muted" />
                  <ULink
            ...
            <div v-if="companySummary" class="space-y-4">
              <h3 class="mb-4 text-lg font-semibold text-default">About Us</h3>
              <p class="text-base text-muted whitespace-pre-line">{{ companySummary }}</p>
            </div>
            <div v-if="companySpecialties.length" class="space-y-4">
              <h3 class="text-lg font-semibold text-default">Specialties</h3>
