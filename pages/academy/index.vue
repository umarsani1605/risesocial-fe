          ...
          <div class="flex-1 space-y-6 lg:space-y-8">
            ...
            <div class="space-y-3 lg:space-y-4">
              <p class="text-sm sm:text-base lg:text-lg text-gray-600 leading-relaxed">
                Rise Sustainability Academy is an online learning program started from 1 up to 5 months live class with experts and mentor to student
                get comprehensive understanding in various sustainability topic.
              </p>
              <p class="text-sm sm:text-base lg:text-lg text-gray-600 leading-relaxed">
                ...
                this topic, equipped with <span class="">JOB ACCELERATOR program</span> with our hiring partners.
              </p>
            </div>
          </div>
